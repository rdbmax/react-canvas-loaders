...
import { Projector, RenderableVertex, RenderableFace, RenderableLine, RenderableSprite } from './Projector'
	...
	*/
	...
	this.render = function ( scene, camera ) {
		...
		if ( camera instanceof Camera === false ) {
			...
			console.error( 'THREE.CanvasRenderer.render: camera is not an instance of Camera.' );
			return;
